...
* Our [bespoke](test_bespoke.qmd) in-house choice of further add-on packages  with `tools::testInstalledPackage`  (note the extra "s" or not in teh function name)


# Post processing summary

This data table shows what _should_ have been tested, and what has actually succeeded (0 is Succes, 1 is Fail), along with date stamps
